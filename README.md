...
Select a passage in any app, press `⌥Space`, and say what you are thinking:
...
Microphone access and the local voice model. The model downloads on first voice
use or when you choose to set it up explicitly.
...
| Key      | Action                                                            |
| -------- | ----------------------------------------------------------------- |
| `⌥Space` | Voice note: hold to talk and release to save, or tap twice       |
...
The six global shortcuts are rebindable in Settings. The typed note save and
discard keys belong to the note box; `⌘Z` belongs to the stack window.
